    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xacnhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(username.getText().toString().equals("huynhnguyenthuongtin") && password.getText().toString().equals("123") && email.getText().toString().equals("tin.hnt.64cntt@ntu.edu.vn")){
                    Intent in = new Intent(MainActivity2.this, MainActivity3.class);
                    in.putExtra("username", "huynhnguyenthuongtin");
                    in.putExtra("password", "123");
                    in.putExtra("email", "tin.hnt.64cntt@ntu.edu.vn");
                    startActivity(in);
                }
                else{
